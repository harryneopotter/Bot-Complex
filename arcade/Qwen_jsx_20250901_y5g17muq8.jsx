...
const App = () => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 text-white">
      ...
      <header className="px-8 py-6">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          <button 
            onClick={() => setActiveTab('bots')}
            className="text-white hover:text-pink-300 transition-colors flex items-center"
          >
            ← Back to Gallery
          </button>
          <div className="text-2xl font-bold bg-gradient-to-r from-pink-400 to-purple-400 bg-clip-text text-transparent">
      ...
      <div className="max-w-6xl mx-auto px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="backdrop-blur-2xl bg-white bg-opacity-10 rounded-2xl border border-white border-opacity-20 p-6 min-h-96">
              ...
              <div className="space-y-4 mb-6">
                <div className="bg-white bg-opacity-20 rounded-2xl p-4 max-w-3xl">
                  ...
                  <p className="text-gray-100">
                    Hello! I'm {selectedBot?.name}, {selectedBot?.tagline.toLowerCase()} 
                    Ready to {selectedBot?.cta.toLowerCase()}? Just tell me what you'd like to explore!
                  </p>
                </div>
              </div>
              ...
              <div className="border-t border-white border-opacity-20 pt-4">
                <div className="flex space-x-2">
                  <input 
                    ...
                    className="flex-1 px-4 py-3 bg-white bg-opacity-20 backdrop-blur-sm rounded-full border border-white border-opacity-30 focus:outline-none focus:ring-2 focus:ring-pink-400"
                  />
                  <button className="px-6 py-3 bg-gradient-to-r from-pink-500 to-purple-600 rounded-full font-semibold hover:from-pink-600 hover:to-purple-700 transition-all">
                    Send
                  </button>
                </div>
                <div className="flex justify-between items-center mt-2 text-sm text-gray-400">
                  <span>Free tier: 2,000 tokens remaining</span>
          ...
          <div className="lg:col-span-1">
            <div className={`backdrop-blur-2xl bg-gradient-to-br ${selectedBot?.gradient} bg-opacity-12 rounded-2xl border border-white border-opacity-20 p-6 h-full`}>
              <div className="text-center mb-6">
                <div className="text-6xl mb-4">{selectedBot?.emoji}</div>
                <h3 className="text-2xl font-bold">{selectedBot?.name}</h3>
                <p className="text-gray-200 text-sm mt-2">{selectedBot?.tagline}</p>
              </div>
              
              <div className="space-y-4 text-sm">
                <div>
                  <h4 className="font-semibold text-pink-300 mb-2">About</h4>
                  <p className="text-gray-200 leading-relaxed">{selectedBot?.description}</p>
                </div>
                
                <div>
                  <h4 className="font-semibold text-pink-300 mb-2">Capabilities</h4>
                ...
                <div>
                  <h4 className="font-semibold text-pink-300 mb-2">Limitations</h4>
                  <ul className="text-gray-200 space-y-1 text-sm">
                    <li>• May take creative liberties</li>
                    <li>• Knowledge cutoff: 2024</li>
                    <li>• Free tier has token limits</li>
                  </ul>
                </div>
              </div>
              
              <div className="mt-6 pt-6 border-t border-white border-opacity-20">
                <div className="bg-white bg-opacity-10 rounded-full h-2 mb-2">
                  <div className="bg-gradient-to-r from-green-400 to-blue-500 h-2 rounded-full" style={{width: '65%'}}></div>
                </div>
                <p className="text-xs text-gray-400 text-center">2,000 / 2,000 tokens used</p>
              </div>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="font-sans">
      ...
      {selectedBot && activeTab === 'bots' && <ChatPage />}
    </div>
  );
};
